...
def exp_data(connection,tname,seq_no,full_exp,low_row_id,upp_row_id):
 table_name = tname 
...
def split_rows(connection,split_partition,tname):
 sql = """select grp,
 ...
 if str(val) == "*":
  for x in Data:
   ...
   if int(x[3])>split_threshold: 
    ...
    exp_data(connection,table_name,"0","Y",0,0)
